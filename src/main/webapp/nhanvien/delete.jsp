...
<div class="container mt-5">
    ...
    <form id="deleteForm" action="${pageContext.request.contextPath}/NhanVienServlet/delete" method="POST">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="selectedIds" value="<%= nhanVien.getId() %>" class="checkbox-item" />
                </td>
            </tr>
            <%
                    }
