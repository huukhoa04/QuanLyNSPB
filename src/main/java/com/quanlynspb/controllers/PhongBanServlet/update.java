...
@WebServlet("/PhongBanServlet/update")
public class update extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            System.out.println("NhanVien: " + phongBan.getIdPb());
            if (Objects.equals(phongBan.getIdPb(), idpb)) {
                req.setAttribute("phongban", phongBan);
                req.getRequestDispatcher("/phongban/update.jsp").forward(req, resp);
            }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            int update = pbn.updatePhongBan(phongBan);
            System.out.println("PhongBan affected: " + update);
            req.setAttribute("updateMessage", "Data updated on this PhongBan");
            req.setAttribute("phongban", phongBan);
